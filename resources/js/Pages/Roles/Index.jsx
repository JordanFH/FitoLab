                                        ...
                                        {data.map(
                                            ({
                                                ...
                                                >
                                                    ...
                                                    <td className="text-justify whitespace-nowrap dark:border-gray-700 border-gray-300 px-4 py-2 overflow-x-auto">
                                                        {permissions.map(
                                                            (
                                                                {
                                                                    name,
                                                                ...
                                                                <>
                                                                    {excludedPermissions.includes(
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            className="inline-flex items-center justify-center px-2 py-1 mr-2 my-1 last:mr-0 text-sm font-bold leading-none text-white dark:bg-teal-700 bg-teal-500 rounded-full"
                                                                        >
                                                                            {
                                                                                description
                                                                            }
